...
//   // Fetch orders - wrapped in useCallback to prevent infinite re-renders
...
//   // Handle Approve
//   const handleApprove = async (orderId, orderNo) => {
...
//   // Handle Reject
//   const handleReject = async (orderId, orderNo) => {
//     if (!canApprove(MODULE_NAME)) {
...
//       setSelectedOrders([]);
//     } else {
//       setSelectedOrders(filteredOrders.map(o => o.originalOrderId));
//     }
//   };
...
//             {/* Bulk Approve - Only shown if user has approve permission and orders selected */}
...
//                           {/* Approve Button - Only shown if user has approve permission and order is not already approved/completed/rejected */}
//                           {canApprove(MODULE_NAME) && order.status !== 'Approved' && order.status !== 'Completed' && order.status !== 'Rejected' && (
//                             <button
//                               onClick={() => handleApprove(order.originalOrderId, order.orderNo)}
...
//                           {/* Reject Button - Only shown if user has approve permission */}
//                           {canApprove(MODULE_NAME) && order.status !== 'Rejected' && order.status !== 'Completed' && (
//                             <button
//                               onClick={() => handleReject(order.originalOrderId, order.orderNo)}
//                               disabled={approveLoading === order.originalOrderId}
