...
// //     // Create new vehicle negotiation with sub-company and approval fields
// //     const newVehicleNegotiation = new VehicleNegotiation({
// //       vnnNo,
// //       branch: body.header?.branch && isValidObjectId(body.header?.branch) ? body.header?.branch : null,
// //       branchName: body.header?.branchName || '',
...
//     // Create new vehicle negotiation with separate approval fields
//     const newVehicleNegotiation = new VehicleNegotiation({
//       vnnNo,
//       branch: body.header?.branch && isValidObjectId(body.header?.branch) ? body.header?.branch : null,
//       branchName: body.header?.branchName || '',
...
// //     // ============================================
// //     // UPDATE APPROVAL WITH SEPARATE FIELDS
// //     // ============================================
// //     if (body.approval) {
// //       // Update Part 1 fields
// //       if (body.approval.part1Status !== undefined) {
// //         vehicleNegotiation.approval.part1Status = body.approval.part1Status;
// //       }
...
// //       }
// //       if (body.approval.vendorCode !== undefined) {
// //         vehicleNegotiation.approval.vendorCode = body.approval.vendorCode;
// //       }
// //       if (body.approval.vendorId !== undefined) {
// //         vehicleNegotiation.approval.vendorId = body.approval.vendorId;
// //       }
// //       if (body.approval.vendorStatus !== undefined) {
// //         vehicleNegotiation.approval.vendorStatus = body.approval.vendorStatus;
// //       }
// //       if (body.approval.rateType !== undefined) {
// //         vehicleNegotiation.approval.rateType = body.approval.rateType;
// //       }
// //       if (body.approval.finalPerMT !== undefined) {
// //         vehicleNegotiation.approval.finalPerMT = Number(body.approval.finalPerMT);
// //       }
...
// //   }
// // }
// // src/app/api/vehicle-negotiation/route.js

// /* ========================================
//    PUT /api/vehicle-negotiation - Supports both 'edit' and 'approve' permissions
// ======================================== */
// export async function PUT(req) {
//   try {
//     await connectDb();
...
//     // Check if the update is primarily about approval fields
...
//     // Check if this is a general edit (non-approval fields)
...
//     // ─── UPDATE SELECTED ORDER PANELS (requires 'edit' permission) ───
//     if (body.selectedOrderPanels && hasEditPermission) {
//       vehicleNegotiation.selectedOrderPanels = body.selectedOrderPanels.map(panel => ({
//         _id: panel._id || '',
//         orderPanelNo: panel.orderPanelNo || '',
//         subCompanyId: panel.subCompanyId || null,
...
//     // ─── UPDATE NEGOTIATION (requires 'edit' permission) ───
//     if (body.negotiation && hasEditPermission) {
//       vehicleNegotiation.negotiation = {
//         maxRate: Number(body.negotiation.maxRate) || vehicleNegotiation.negotiation?.maxRate || 0,
//         targetRate: Number(body.negotiation.targetRate) || vehicleNegotiation.negotiation?.targetRate || 0,
//         purchaseType: body.negotiation.purchaseType || vehicleNegotiation.negotiation?.purchaseType || 'Loading & Unloading',
...
//     // ─── UPDATE VOICE NOTE (requires 'edit' permission) ───
//     if (body.voiceUrl !== undefined && hasEditPermission) {
//       vehicleNegotiation.voiceNote = body.voiceUrl;
//     }
//     if (body.voiceFileInfo && hasEditPermission) {
//       vehicleNegotiation.voiceNoteFile = body.voiceFileInfo;
//     }

//     // ─── UPDATE APPROVAL FIELDS (requires 'approve' permission) ───
//     if (body.approval && hasApprovePermission) {
//       // Update Part 1 fields
//       if (body.approval.part1Status !== undefined) {
//         vehicleNegotiation.approval.part1Status = body.approval.part1Status;
//       }
...
//         if (body.remarks !== undefined) vehicleNegotiation.approval.part2Remarks = body.remarks;
...
export async function POST(req) {
  try {
    ...
    const processedOrders = (body.orders || []).map(order => ({
      ...
      state: order.state || '',
      stateName: order.stateName || '',
      stateId: order.stateId && isValidObjectId(order.stateId) ? order.stateId : null,
      district: order.district || '',
      districtName: order.districtName || '',
      districtId: order.districtId && isValidObjectId(order.districtId) ? order.districtId : null,
      talukaId: order.talukaId && isValidObjectId(order.talukaId) ? order.talukaId : null,
      weight: Number(order.weight) || 0,
      status: order.status || 'Open',
      collectionCharges: Number(order.collectionCharges) || 0,
      cancellationCharges: order.cancellationCharges || 'Nil',
...
/* ========================================
   PATCH /api/vehicle-negotiation - Requires 'approve' permission
   Specifically for approval/rejection actions
======================================== */
/* ========================================
   PATCH /api/vehicle-negotiation - Requires 'approve' permission
   Specifically for approval/rejection actions
